...
$links = array(
    ...
    "Assignment/Seller/Manage/Accept/Negotiations"=>"./src/pages/Seller/AcceptNegotiations.php",
    "Assignment/Seller/Manage/Reject/Negotiations"=>"./src/pages/Seller/RejectNegotitations.php",
