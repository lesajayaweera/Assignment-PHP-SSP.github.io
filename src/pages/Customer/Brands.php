...
<body class="capitalize text-lg font-family-montserrat">
  <header class="flex flex-wrap items-center justify-between bg-black text-white p-4" id="header">
    <!-- Branding -->
    <div>
    ...
    <!-- Nav Menu -->
    <nav class="w-full md:w-auto md:block hidden" id="nav">
      <ul class="flex flex-col md:flex-row md:items-center gap-4 md:gap-6 mt-4 md:mt-0 text-lg font-family-montserrat">
    ...
    <div>
      ...
      <button title="mobile" type="button" id="hamburger"
      class="flex flex-col justify-between w-6 h-5 cursor-pointer md:hidden ml-auto">
