                    ...
                    <div class="my-6">
                        ...
                        <div class="flex flex-col gap-2 mb-4">
                            ...
                            <div class="flex space-x-4">
                                <div id="thumbPreview1"
                                    class="w-[200px] h-[120px] bg-gray-200 border rounded flex items-center justify-center text-xs">
                                    Thumbnail 1</div>
                                <div id="thumbPreview2"
                                    class="w-[200px] h-[120px] bg-gray-200 border rounded flex items-center justify-center text-xs">
                                    Thumbnail 2</div>
                                <div id="thumbPreview3"
                                    class="w-[200px] h-[120px] bg-gray-200 border rounded flex items-center justify-center text-xs">
                                    Thumbnail 3</div>
                                <div>
                    ...
                    <div class="my-6">
                        ...
                        <form class="mt-4 space-y-6">
                            ...
                            <div>
                                <h3 class="font-medium text-gray-700 mb-2">Interior</h3>
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                                    <label class="flex items-center gap-2"><input type="checkbox" name="features[]"
                                            value="Air Conditioner" /> Air Conditioner</label>
                                    <label class="flex items-center gap-2"><input type="checkbox" name="features[]"
                                            value="Touchscreen Display" /> Touchscreen Display</label>
                                    <label class="flex items-center gap-2"><input type="checkbox" name="features[]"
                                            value="Leather Seats" /> Leather Seats</label>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                                    <label class="flex items-center gap-2"><input type="checkbox" name="features[]"
                                            value="Anti-Lock Braking" /> Anti-Lock Braking</label>
                                    <label class="flex items-center gap-2"><input type="checkbox" name="features[]"
                                            value="Driver Air Bag" /> Driver Air Bag</label>
                                    <label class="flex items-center gap-2"><input type="checkbox" name="features[]"
                                            value="Rearview Camera" /> Rearview Camera</label>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                                    <label class="flex items-center gap-2"><input type="checkbox" name="features[]"
                                            value="Fog Lights Front" /> Fog Lights Front</label>
                                    <label class="flex items-center gap-2"><input type="checkbox" name="features[]"
                                            value="Alloy Wheels" /> Alloy Wheels</label>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                                    <label class="flex items-center gap-2"><input type="checkbox" name="features[]"
                                            value="Bluetooth" /> Bluetooth</label>
                                    <label class="flex items-center gap-2"><input type="checkbox" name="features[]"
                                            value="Cruise Control" /> Cruise Control</label>
                                    <label class="flex items-center gap-2"><input type="checkbox" name="features[]"
                                            value="Remote Keyless Entry" /> Remote Keyless Entry</label>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="my-6 space-y-8 ">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="flex flex-col">
                                    <label class="font-semibold">Length (mm)</label>
                                    <input type="number" name="length" class="border border-gray-300 rounded p-2"
                                        placeholder="4950" required>
                                </div>
                                ...
                                <div class="flex flex-col">
                                    <label class="font-semibold">Height (mm)</label>
                                    <input type="number" name="height" class="border border-gray-300 rounded p-2"
                                        placeholder="1550" required>
                                </div>

                                <div class="flex flex-col">
                                    <label class="font-semibold">Width (Including Mirrors) (mm)</label>
                                    <input type="number" name="width_mirrors" class="border border-gray-300 rounded p-2"
                                        placeholder="2140" required>
                                </div>

                                <div class="flex flex-col">
                                    <label class="font-semibold">Wheelbase (mm)</label>
                                    <input type="number" name="wheelbase" class="border border-gray-300 rounded p-2"
                                        placeholder="2580" required>
                                </div>

                                <div class="flex flex-col">
                                    <label class="font-semibold">Gross Vehicle Weight (kg)</label>
                                    <input type="number" name="gross_vehicle_weight"
                                        class="border border-gray-300 rounded p-2" placeholder="1550" required>
                                </div>

                                <div class="flex flex-col">
                                    <label class="font-semibold">Height (Roof Rails) (mm)</label>
                                    <input type="number" name="roof_rails_height"
                                        class="border border-gray-300 rounded p-2" placeholder="1850">
                                </div>

                                <div class="flex flex-col">
                                    <label class="font-semibold">Max Loading Weight (kg)</label>
                                    <input type="number" name="max_loading_weight"
                                        class="border border-gray-300 rounded p-2" placeholder="1200">
                                </div>

                                <div class="flex flex-col">
                                    <label class="font-semibold">Max Roof Load (kg)</label>
                                    <input type="number" name="max_roof_load" class="border border-gray-300 rounded p-2"
                                        placeholder="400">
                                </div>

                                <div class="flex flex-col">
                                    <label class="font-semibold">Luggage Capacity (Seats Up) (L)</label>
                                    <input type="number" name="luggage_up" class="border border-gray-300 rounded p-2"
                                        placeholder="480">
                                </div>

                                <div class="flex flex-col">
                                    <label class="font-semibold">Luggage Capacity (Seats Down) (L)</label>
                                    <input type="number" name="luggage_down" class="border border-gray-300 rounded p-2"
                                        placeholder="850">
                                </div>

                                <div class="flex flex-col">
                                    <label class="font-semibold">No. of Seats</label>
                                    <input type="number" name="num_seats" class="border border-gray-300 rounded p-2"
                                        placeholder="5">
                                </div>
                        ...
                        <div class="mt-6">
                            <button type="submit"
                                class="bg-blue-600 text-white py-2 px-6 rounded hover:bg-blue-700">Save Details</button>
                        </div>
                    </div>
