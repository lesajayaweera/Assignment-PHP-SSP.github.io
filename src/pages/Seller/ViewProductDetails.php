    ...
    <main class="flex-1 p-6  space-y-6 w-full lg:pl-[-20%] ">
      ...
      <!-- Title & Subheading -->
       <div class="flex items-center justify-between mb-6">
        <div><h1 class="text-3xl  font-semibold text-gray-900">Toyota Camry New</h1></div>
       </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
          ...
          <div class="border rounded-lg p-4 space-y-4">
            <div class="flex items-center space-x-4">
              <img title="images" src="/Assignment/assets/images/profile pic.jpg" class="w-12 rounded-full">
              <div>
