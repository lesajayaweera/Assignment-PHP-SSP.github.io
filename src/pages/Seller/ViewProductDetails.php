...
<body class="bg-gray-100 ">
    ...
    <div class="flex min-h-screen ">
        <!-- Desktop Sidebar    -->
        <aside class="hidden lg:block lg:w-1/5 bg-black text-white p-6 fixed z-10 top-0 bottom-0 left-0 ">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="border rounded-lg p-4 space-y-4">
                        <div class="flex items-center space-x-4">
                            <img title="images"
                                src="<?php echo isset($vehicleData['seller']['image_path']) ? htmlspecialchars($vehicleData['seller']['image_path']) : 'https://i.pravatar.cc/150?img=4'; ?>"
                                class="w-12 rounded-full">

                            <div>
                                <p class="font-medium">
                                    <?php 
                                        if (isset($vehicleData['seller']['firstName']) && isset($vehicleData['seller']['lastName'])) {
                                            echo htmlspecialchars($vehicleData['seller']['firstName']) . " " . htmlspecialchars($vehicleData['seller']['lastName']);
                                        } else {
                                            echo $_SESSION['name'];
                                        }
                                    ?>
                                ...
                                <p class="text-sm">📞
                                    <?php 
                                        echo isset($vehicleData['seller']['email']) 
                                            ? htmlspecialchars($vehicleData['seller']['email']) 
                                            : $_SESSION['email']; 
                                        ?>
                                </p>
                        ...
                        <a href="/Assignment/Seller/ManageProducts"
                            class="block text-sm text-blue-600 hover:underline text-center">View All stock at
                            this dealer →</a>
                    </div>
                </div>
            </div>
