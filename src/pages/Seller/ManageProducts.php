...
<head>
    ...
    <title> Seller - View Listings</title>
...
<body class="bg-gray-100 font-sans">
    ...
    <div id="mobileSidebar"
        class="fixed inset-0 z-40 bg-black text-white w-3/4 max-w-xs transform -translate-x-full transition-transform font-family-montserrat duration-300 lg:hidden">
        <div class="p-6 space-y-4">
            ...
            <nav class="space-y-3">
                ...
                <a href="/Assignment/Seller/ManageProducts" class="block px-4 py-2  bg-gray-800 rounded">Manage
                    Products</a>
    ...
    <div class="flex min-h-screen font-sans">
        ...
        <!-- Main Content -->
        <section class="flex-1 p-6 font-family-montserrat space-y-6 w-4/5 lg:ml-[20%] font-sans">
            <!-- Header -->
                ...
                <div class="max-w-xs bg-white rounded-lg shadow-md text-center font-sans overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-center gap-4">
                            <button
                                class="flex-1 bg-green-500 text-white px-5 py-2 rounded hover:bg-green-600 capitalize transition">
                                <a href="/Assignment/Seller/EditCar?id=<?= htmlspecialchars($car['VehicleID']) ?>">Edit</a>
                            </button>
                            <button
